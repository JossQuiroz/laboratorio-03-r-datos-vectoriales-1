...
ggplot(centro_america, aes(x=reorder(name_long, -lifeExp), y=lifeExp)) +
  ggtitle("Datos demograficos de paises de Centroamerica") +
  xlab("País") + 
...
```{r}
plot(centro_america["lifeExp"], main="Datos demograficos de paises de Centroamerica")
```
...
plot(centro_america_lifeExp["lifeExp"], main="Esperanza de Vida igual o mayor 74 años en Centroamerica")
```