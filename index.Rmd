...
ggplot(centro_america, aes(x=reorder(name_long, -lifeExp), y=lifeExp)) +
  ggtitle("Esperanza de Vida en paises de Centroamerica") +
  xlab("País") + 
  ylab("Esperanza de Vida") +  
  geom_col() +
  geom_text(aes(label=lifeExp), vjust=-0.3, size=3.3) + 
  geom_bar(stat = "identity", fill = "yellow",colour= "orange")
```
...
```{r}
plot(centro_america["lifeExp"], main="Esperanza de Vida en paises de Centroamerica")
```
...
```{r}
centro_america_lifeExp <- centro_america[centro_america$lifeExp >= 74,]
plot(centro_america_lifeExp["lifeExp"], main="Esperanza de Vida mayor o igual a 74 años en Centroamerica")
```